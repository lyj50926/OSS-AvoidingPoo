...
#나의 이름
my_name = game_font3.render("22team", True, (255, 255, 255))

the_end = game_font2.render("THE END",True,(0,0,0))

date = game_font3.render("2022-11-22",True,(255,255,255))
...
# ending background
e_background = pygame.image.load("./resources/end_bg.png")
...
ddong3 = pygame.image.load("./resources/ddong.png")
ddong4 = pygame.image.load("./resources/ddong.png")
...
#help 화면
    ...
    # 다음 게임을 위한 초기화
    # character
    character = pygame.image.load("./resources/캐릭터.png")
